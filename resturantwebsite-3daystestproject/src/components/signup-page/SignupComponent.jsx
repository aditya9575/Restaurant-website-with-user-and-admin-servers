...
const SignupComponent = () => {
  ...
  const validateForm = () => {
    const { restaurantName, mobileNumber, email, password, confirmPassword } = formData;

    if (!restaurantName || !mobileNumber || !email || !password || !confirmPassword) {
  ...
  const storeUserData = async (data) => {
    try {
      await axios.post('https://foodgenie-298de-default-rtdb.firebaseio.com/users.json', data);
